...
class WorkoutedDatabaseCallback @Inject constructor() : RoomDatabase.Callback() {
    ...
    private fun seedData(db: SupportSQLiteDatabase) {
        Log.d("DatabaseSeeding", "Seeding database with technical keys...")
        
        // 1. Muscle Groups (Names are now technical keys for localization)
        val groups = listOf(
        ...
        // 2. Muscles (Names are now technical keys)
        val muscles = listOf(
            ...
            arrayOf("m_triceps", "group_arms", "m_triceps", 0.55),
            arrayOf("m_biceps", "group_arms", "m_biceps", 0.35),
            arrayOf("m_forearms", "group_arms", "m_forearms", 0.10),
        ...
        // 3. Exercises (Names are now technical keys)
        val exercisesData = listOf(
            ...
            ExerciseData("ex_cable_crossover", 50.0, listOf("m_chest_mid" to 1.0, "m_chest_upper" to 0.4)),
            ...
            ExerciseData("ex_hack_squats", 180.0, listOf("m_quads" to 1.0, "m_glutes" to 0.4)),
            ...
            ExerciseData("ex_leg_press", 300.0, listOf("m_quads" to 1.0, "m_glutes" to 0.6, "m_hamstrings" to 0.2)),
            ...
            ExerciseData("ex_leg_curl", 75.0, listOf("m_hamstrings" to 1.0, "m_calves" to 0.2)),
            ExerciseData("ex_leg_extension", 95.0, listOf("m_quads" to 1.0)),
            ...
            ExerciseData("ex_lat_pulldown", 100.0, listOf("m_lats" to 1.0, "m_biceps" to 0.5, "m_rhomboids" to 0.4)),
            ExerciseData("ex_seated_cable_row", 110.0, listOf("m_lats" to 1.0, "m_rhomboids" to 0.9, "m_traps" to 0.5, "m_biceps" to 0.4, "m_lower_back" to 0.3)),
            ...
            ExerciseData("ex_tricep_extension_cable", 45.0, listOf("m_triceps" to 1.0)),
            ...
            ExerciseData("ex_cable_crunches", 80.0, listOf("m_abs" to 1.0, "m_obliques" to 0.2)),
            ...
            ExerciseData("ex_pec_deck", 80.0, listOf("m_chest_mid" to 1.0, "m_delt_front" to 0.3)),
            ExerciseData("ex_chest_press_machine", 100.0, listOf("m_chest_mid" to 1.0, "m_delt_front" to 0.6, "m_triceps" to 0.5)),
            ExerciseData("ex_hammer_strength_chest_mid", 120.0, listOf("m_chest_mid" to 1.0, "m_delt_front" to 0.5, "m_triceps" to 0.4)),
            ExerciseData("ex_hammer_strength_chest_upper", 100.0, listOf("m_chest_upper" to 1.0, "m_delt_front" to 0.6, "m_triceps" to 0.4)),
            ExerciseData("ex_smith_bench_press", 100.0, listOf("m_chest_mid" to 1.0, "m_delt_front" to 0.6, "m_triceps" to 0.5)),
            ExerciseData("ex_smith_incline_press", 80.0, listOf("m_chest_upper" to 1.0, "m_delt_front" to 0.6, "m_triceps" to 0.4)),
            ExerciseData("ex_cable_bicep_curl", 50.0, listOf("m_biceps" to 1.0, "m_forearms" to 0.3)),
            ExerciseData("ex_low_pulley_bicep_curl", 60.0, listOf("m_biceps" to 1.0, "m_forearms" to 0.4)),
            ExerciseData("ex_tricep_rope_pushdown", 50.0, listOf("m_triceps" to 1.0)),
            ExerciseData("ex_tricep_straight_bar_pushdown", 60.0, listOf("m_triceps" to 1.0)),
            ExerciseData("ex_bicep_curl_machine", 60.0, listOf("m_biceps" to 1.0)),
            ExerciseData("ex_tricep_extension_machine", 70.0, listOf("m_triceps" to 1.0)),
            ExerciseData("ex_hip_abduction", 70.0, listOf("m_glutes" to 1.0)),
            ExerciseData("ex_hip_adduction", 80.0, listOf("m_quads" to 0.5, "m_glutes" to 0.5)),
            ExerciseData("ex_smith_squats", 120.0, listOf("m_quads" to 1.0, "m_glutes" to 0.7, "m_hamstrings" to 0.3)),
            ExerciseData("ex_smith_lunges", 80.0, listOf("m_quads" to 1.0, "m_glutes" to 0.9, "m_hamstrings" to 0.3)),
            ExerciseData("ex_smith_hip_thrust", 140.0, listOf("m_glutes" to 1.0, "m_hamstrings" to 0.4, "m_lower_back" to 0.2)),
            ExerciseData("ex_cable_kickback", 30.0, listOf("m_glutes" to 1.0, "m_hamstrings" to 0.3)),
            ExerciseData("ex_seated_leg_curl", 80.0, listOf("m_hamstrings" to 1.0, "m_calves" to 0.2)),
            ExerciseData("ex_single_leg_press", 150.0, listOf("m_quads" to 1.0, "m_glutes" to 0.6, "m_hamstrings" to 0.2)),
            ExerciseData("ex_calf_press_on_leg_press", 200.0, listOf("m_calves" to 1.0)),
            ExerciseData("ex_reverse_hack_squat", 160.0, listOf("m_glutes" to 1.0, "m_quads" to 0.8, "m_hamstrings" to 0.4)),
            ExerciseData("ex_smith_shoulder_press", 70.0, listOf("m_delt_front" to 1.0, "m_triceps" to 0.6, "m_delt_lateral" to 0.4)),
            ExerciseData("ex_hammer_shoulder_press", 80.0, listOf("m_delt_front" to 1.0, "m_triceps" to 0.6, "m_delt_lateral" to 0.4)),
            ExerciseData("ex_seated_row_cable", 100.0, listOf("m_lats" to 1.0, "m_rhomboids" to 0.9, "m_traps" to 0.5, "m_biceps" to 0.4, "m_lower_back" to 0.3)),
            ExerciseData("ex_cable_pullover", 50.0, listOf("m_lats" to 1.0, "m_chest_mid" to 0.5, "m_triceps" to 0.3)),
            ExerciseData("ex_reverse_peck_deck", 40.0, listOf("m_delt_rear" to 1.0, "m_rhomboids" to 0.4, "m_traps" to 0.3)),
            ExerciseData("ex_hammer_lat_pulldown", 110.0, listOf("m_lats" to 1.0, "m_biceps" to 0.5, "m_rhomboids" to 0.4)),
            ExerciseData("ex_hammer_seated_row", 120.0, listOf("m_lats" to 1.0, "m_rhomboids" to 0.8, "m_traps" to 0.6, "m_biceps" to 0.5)),
            ...
            ExerciseData("ex_high_cable_curl", 40.0, listOf("m_biceps" to 1.0)),
            ...
            ExerciseData("ex_face_pulls", 50.0, listOf("m_delt_rear" to 1.0, "m_rhomboids" to 0.8, "m_traps" to 0.6, "m_biceps" to 0.3)),
            ExerciseData("ex_one_arm_cable_lateral_raise", 15.0, listOf("m_delt_lateral" to 1.0)),
            ExerciseData("ex_cable_reverse_fly", 25.0, listOf("m_delt_rear" to 1.0, "m_rhomboids" to 0.5)),
            ExerciseData("ex_one_arm_low_pulley_row", 60.0, listOf("m_lats" to 1.0, "m_rhomboids" to 0.7, "m_biceps" to 0.4)),
            ExerciseData("ex_v_bar_pull_ups", 110.0, listOf("m_lats" to 1.0, "m_biceps" to 0.8, "m_forearms" to 0.5)),
            ExerciseData("ex_reverse_grip_lat_pulldown", 100.0, listOf("m_lats" to 1.0, "m_biceps" to 0.8, "m_rhomboids" to 0.4)),
            ExerciseData("ex_straight_arm_pulldown", 60.0, listOf("m_lats" to 1.0, "m_triceps" to 0.3)),
            ...
            ExerciseData("ex_cable_woodchopper", 40.0, listOf("m_obliques" to 1.0, "m_abs" to 0.7, "m_delt_front" to 0.3)),

...
class WorkoutedDatabaseCallback @Inject constructor() : RoomDatabase.Callback() {
    ...
    override fun onOpen(db: SupportSQLiteDatabase) {
        super.onOpen(db)
        // Update data without destructive operations
        seedData(db)
    }
    ...
    private fun seedData(db: SupportSQLiteDatabase) {
        ...
        val exercisesData = listOf(
            ...
            ExerciseData("ex_cable_crossover", 100.0, listOf("m_chest_mid" to 1.0, "m_chest_upper" to 0.4)),
            ...
            ExerciseData("ex_leg_press", 500.0, listOf("m_quads" to 1.0, "m_glutes" to 0.6, "m_hamstrings" to 0.2)),
            ...
            ExerciseData("ex_leg_curl", 120.0, listOf("m_hamstrings" to 1.0, "m_calves" to 0.2)),
            ExerciseData("ex_leg_extension", 150.0, listOf("m_quads" to 1.0)),
            ...
            ExerciseData("ex_lat_pulldown", 200.0, listOf("m_lats" to 1.0, "m_biceps" to 0.5, "m_rhomboids" to 0.4)),
            ExerciseData("ex_seated_cable_row", 200.0, listOf("m_lats" to 1.0, "m_rhomboids" to 0.9, "m_traps" to 0.5, "m_biceps" to 0.4, "m_lower_back" to 0.3)),
            ...
            ExerciseData("ex_tricep_extension_cable", 220.0, listOf("m_triceps" to 1.0)),
            ...
            ExerciseData("ex_pec_deck", 180.0, listOf("m_chest_mid" to 1.0, "m_delt_front" to 0.3)),
            ExerciseData("ex_chest_press_machine", 220.0, listOf("m_chest_mid" to 1.0, "m_delt_front" to 0.6, "m_triceps" to 0.5)),
            ExerciseData("ex_hammer_strength_chest_mid", 200.0, listOf("m_chest_mid" to 1.0, "m_delt_front" to 0.5, "m_triceps" to 0.4)),
            ExerciseData("ex_hammer_strength_chest_upper", 180.0, listOf("m_chest_upper" to 1.0, "m_delt_front" to 0.6, "m_triceps" to 0.4)),
            ...
            ExerciseData("ex_cable_bicep_curl", 220.0, listOf("m_biceps" to 1.0, "m_forearms" to 0.3)),
            ExerciseData("ex_low_pulley_bicep_curl", 240.0, listOf("m_biceps" to 1.0, "m_forearms" to 0.4)),
            ExerciseData("ex_tricep_rope_pushdown", 230.0, listOf("m_triceps" to 1.0)),
            ExerciseData("ex_tricep_straight_bar_pushdown", 240.0, listOf("m_triceps" to 1.0)),
            ExerciseData("ex_bicep_curl_machine", 100.0, listOf("m_biceps" to 1.0)),
            ExerciseData("ex_tricep_extension_machine", 110.0, listOf("m_triceps" to 1.0)),
            ExerciseData("ex_hip_abduction", 120.0, listOf("m_glutes" to 1.0)),
            ExerciseData("ex_hip_adduction", 130.0, listOf("m_quads" to 0.5, "m_glutes" to 0.5)),
            ...
            ExerciseData("ex_cable_kickback", 60.0, listOf("m_glutes" to 1.0, "m_hamstrings" to 0.3)),
            ExerciseData("ex_seated_leg_curl", 130.0, listOf("m_hamstrings" to 1.0, "m_calves" to 0.2)),
            ...
            ExerciseData("ex_seated_row_cable", 180.0, listOf("m_lats" to 1.0, "m_rhomboids" to 0.9, "m_traps" to 0.5, "m_biceps" to 0.4, "m_lower_back" to 0.3)),
            ExerciseData("ex_cable_pullover", 90.0, listOf("m_lats" to 1.0, "m_chest_mid" to 0.5, "m_triceps" to 0.3)),
            ExerciseData("ex_reverse_peck_deck", 80.0, listOf("m_delt_rear" to 1.0, "m_rhomboids" to 0.4, "m_traps" to 0.3)),
            ExerciseData("ex_hammer_lat_pulldown", 200.0, listOf("m_lats" to 1.0, "m_biceps" to 0.5, "m_rhomboids" to 0.4)),
            ExerciseData("ex_hammer_seated_row", 200.0, listOf("m_lats" to 1.0, "m_rhomboids" to 0.8, "m_traps" to 0.6, "m_biceps" to 0.5)),
            ...
            ExerciseData("ex_high_cable_curl", 80.0, listOf("m_biceps" to 1.0)),
            ...
            ExerciseData("ex_face_pulls", 90.0, listOf("m_delt_rear" to 1.0, "m_rhomboids" to 0.8, "m_traps" to 0.6, "m_biceps" to 0.3)),
            ExerciseData("ex_one_arm_cable_lateral_raise", 30.0, listOf("m_delt_lateral" to 1.0)),
            ExerciseData("ex_cable_reverse_fly", 50.0, listOf("m_delt_rear" to 1.0, "m_rhomboids" to 0.5)),
            ExerciseData("ex_one_arm_low_pulley_row", 110.0, listOf("m_lats" to 1.0, "m_rhomboids" to 0.7, "m_biceps" to 0.4)),
            ExerciseData("ex_v_bar_pull_ups", 110.0, listOf("m_lats" to 1.0, "m_biceps" to 0.8, "m_forearms" to 0.5)),
            ExerciseData("ex_reverse_grip_lat_pulldown", 180.0, listOf("m_lats" to 1.0, "m_biceps" to 0.8, "m_rhomboids" to 0.4)),
            ExerciseData("ex_straight_arm_pulldown", 100.0, listOf("m_lats" to 1.0, "m_triceps" to 0.3)),
            ...
            ExerciseData("ex_cable_woodchopper", 80.0, listOf("m_obliques" to 1.0, "m_abs" to 0.7, "m_delt_front" to 0.3)),
        ...
        exercisesData.forEachIndexed { index, data ->
            ...
            data.impacts.forEach { (muscleId, coef) ->
                ...
                db.update("muscle_impacts", SQLiteDatabase.CONFLICT_NONE, impValues, "exerciseId = ? AND muscleId = ?", arrayOf(exerciseId.toString(), muscleId))
            }
        }
    }
